...
--
-- Host: 127.0.0.1
-- Generation Time: 13-Nov-2018 às 17:19
...
-- Database: `pessoa`
--
CREATE DATABASE IF NOT EXISTS `pessoa` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `pessoa`;
...
INSERT INTO `cidades` (`id`, `cid_nome`, `estados_id`) VALUES
(3, 'Brasiléia', 1),
(4, 'Bujari', 1),
(5, 'Capixaba', 1),
(6, 'Cruzeiro do Sul', 1),
