                    ...
                    <div class="col-md-12">
                        <form class="" method="post" action="controleEstoque.php">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="descricao" name="descricao" placeholder="Digite o nome do produto"> 
                            </div>
                            <div class="form-group">
                                <label for="quantidade">Quantidade</label>
                                <input type="number" class="form-control" placeholder="Digite a quantidade" id="quantidade" name="quantidade"> 
                            </div>
                            <button type="submit" class="btn btn-primary" name="opcao" value="Cadastrar">Cadastrar</button>
                            <a class="btn btn-light" href="paginaInicial.php">Cancelar
                            <br>
                            </a>
                        </form>
                    </div>
